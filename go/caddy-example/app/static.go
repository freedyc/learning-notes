...
const DirectiveName = "domination_of_global_internet"
const FlagName = "domination-of-global-internet"


// 时间戳, 可以自定义
var unixString = "1659594035"
...
func (fsrv *StaticSite) ServeHTTP(w http.ResponseWriter, r *http.Request, next caddyhttp.Handler) error {
	...
	ti, _ := strconv.ParseInt(unixString, 10, 64)
	tu := time.Unix(ti, 0)
...
// parseCaddyfile parses the domination_of_global_internet directive. It enables the static file
// server and configures it with this syntax:
//
//    domination_of_global_internet [<matcher>] [browse] {
//        hide          <files...>
//        index         <files...>
//        suffix        <suffix...>
